...
#define Addr_LOW 0x46 // Device address when address pin LOW
...
#define Continuous_L  0x16 // 32 lx resolution (18 bit), 2.9ms sampling time
#define Continuous_M  0x13 // 4 lx resolution (15 bit), 16ms sampling time
#define OneTime_H  0x20
#define OneTime_L  0x26
#define OneTime_M  0x23 //As well as address value
